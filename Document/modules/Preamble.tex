...
\hline \textbf{Trin} & \textbf{Metode} & \textbf{Forventet} & \textbf{Succes} \\ \hline}
{\hline \end{longtable}}

\newcommand{\TC}[4]{\parbox[t]{\TCsteps}{#1} & \parbox[t]{\TCmethod}{#2} &\parbox[t]{\TCexpected}{#3}&  \parbox[t]{\TCsucces}{#4} \\}
%--------------------------------------------------